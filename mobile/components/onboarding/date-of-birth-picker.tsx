...
const styles = StyleSheet.create({
  ...
  title: { color: colors.pearl, fontSize: 17, fontWeight: "700", letterSpacing: -0.4 },
  done: {
  ...
  doneDisabled: { backgroundColor: "rgba(255,255,255,0.10)" },
  doneLabel: { color: colors.ink, fontSize: 14, fontWeight: "800" },
  ...
  itemTextActive: { color: colors.pearl, fontSize: 17, fontWeight: "800" },
  note: {
    marginTop: 12,
    color: colors.mist,
    fontSize: 12,
