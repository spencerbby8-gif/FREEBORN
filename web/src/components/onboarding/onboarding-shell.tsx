...
export function OnboardingShell({ children }: { children: React.ReactNode }) {
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="orb absolute -left-24 -top-24 h-80 w-80 rounded-full bg-[rgba(239,94,94,0.10)] blur-[2px]" />
      <div className="orb orb-alt absolute -right-24 top-10 h-96 w-96 rounded-full bg-[rgba(138,110,242,0.10)] blur-[2px]" />
