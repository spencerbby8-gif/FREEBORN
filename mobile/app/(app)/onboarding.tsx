          ...
          <View style={styles.formStack}>
            ...
            {step === "about_you" && (
              <>
                ...
                <OnboardingInput label="Country code" value={draft.country_code} error={errors.country_code} placeholder="US" onChangeText={(value) => update("country_code", value.toUpperCase())} hint={onboardingFieldHints.country_code} optional maxLength={2} />
              </>
            )}

            {step === "bio_goals" && (
              <>
                <OnboardingInput label="Short bio" value={draft.bio} error={errors.bio} placeholder="What do you value? What does a good Sunday or wellness rhythm look like?" onChangeText={(value) => update("bio", value.slice(0, 500))} hint={`${draft.bio.length}/500 · ${onboardingFieldHints.bio}`} multiline style={styles.bioInput} />
                <View style={styles.field}>
...
const styles = StyleSheet.create({
  ...
  eyebrowDot: { width: 8, height: 8, borderRadius: 999, backgroundColor: colors.gold300 },
  eyebrowLabel: { color: colors.sand, fontSize: 10, fontWeight: "900", letterSpacing: 2.4, textTransform: "uppercase" },
  title: { marginTop: 16, color: colors.pearl, fontSize: 26, lineHeight: 32, fontWeight: "900", letterSpacing: -1.2 },
  ...
  counter: { color: colors.ash, fontSize: 10, fontWeight: "900", letterSpacing: 1.4, textTransform: "uppercase" },
  ...
  inputError: { borderColor: "rgba(255, 158, 160, 0.5)" },
  ...
  completeCheckGlyph: { color: colors.ink, fontSize: 32, fontWeight: "900" },
  completeTitle: { marginTop: 6, color: colors.pearl, fontSize: 22, fontWeight: "900", letterSpacing: -0.6 },
  ...
  completeDot: { width: 8, height: 8, borderRadius: 999, backgroundColor: colors.gold300, marginTop: 7 },
