  ...
  return (
    <DetailScreenShell title="Settings" subtitle="Manage your experience">
      <SurfaceCard gap={6} noPadding style={styles.section}>
        ...
        <NavCard icon="☤" title="Account" subtitle="Email, password, sign out" accent="gold" onPress={() => router.push("/(app)/settings/account")} />
      ...
      <SurfaceCard gap={6} noPadding style={styles.section}>
        ...
        <NavCard icon="♼" title="Notifications" subtitle="Match alerts, message alerts" accent="ember" onPress={() => router.push("/(app)/settings/notifications")} />
      </SurfaceCard>
      ...
      <SurfaceCard gap={6} noPadding style={styles.section}>
        ...
        <NavCard icon="♦" title="Subscription" subtitle="Manage your plan" accent="gold" onPress={() => router.push("/(app)/settings/subscription")} />
        <NavCard icon="❓" title="Support" subtitle="Help, feedback, contact" accent="violet" onPress={() => router.push("/(app)/settings/support")} />
        <NavCard icon="⚙" title="App Preferences" subtitle="Appearance, language" accent="violet" onPress={() => router.push("/(app)/settings/preferences")} />
